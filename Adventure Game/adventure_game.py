...
def displayIntro():
    ...
    time.sleep(2)
    print("and the other leads through a gamma "
          "ray burst that will disentigrate you")
    print()
...
def checkPath(chosenPath):
    ...
    time.sleep(2)
    print("there's an asteroid nearby that looks"
          " familiar, that must be a good sign...")
    time.sleep(2)
    ...
    if chosenPath == str(correctPath):
        print("That tingling was just the feeling of admiration"
